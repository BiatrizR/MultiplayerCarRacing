  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //usando os dados do banco de dados para exibir os carros nas direções x e y
        ...
        if (index === player.index) {
          ...
          // utilizando o objeto camera para seguir os carros em Y
